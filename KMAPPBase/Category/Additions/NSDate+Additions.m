...
+ (NSString *)dateStringFromDate:(NSString *)dateStr dayCount:(NSInteger)dayCount{
    
    NSDateFormatter *dateFomatter = [[NSDateFormatter alloc]init];
    [dateFomatter setDateFormat:@"yyyy-MM-dd"];
    NSDate * dateA  = [dateFomatter dateFromString:dateStr];
    NSTimeInterval timeIntercal = (dayCount-1) *(24 * 60 * 60);
    NSDate   *dateB = [dateA dateByAddingTimeInterval:timeIntercal];
    NSString * str = [dateFomatter stringFromDate:dateB];
    return str;
}
...
+ (NSString *)weekStrFromDateStr:(NSString *)dateStr{
    ...
    NSString *monsthStr = [formatter stringFromDate:date];
    NSMutableString *muStr = [[NSMutableString alloc]init];
    [muStr appendString:monsthStr];
    [muStr appendString:@" "];

    [muStr appendString: [NSDate getWeekStringFromInteger:(int)components.weekday]];
    return muStr;
}
