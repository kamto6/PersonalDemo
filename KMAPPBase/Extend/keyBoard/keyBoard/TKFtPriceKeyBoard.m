...
@interface TKFtPriceKeyBoard ()

@property (nonatomic, assign)  TKFtKeyBoardType type;

@end


@implementation TKFtPriceKeyBoard
...
-(void)setupView
{
    ...
    NSArray *priceBtnTitles = @[@"排队价",@"对手价",@"市价",@"最新价",@"超价"];
    if (_type == TKFtKeyBoardTypeCloudCondition) {
        priceBtnTitles = @[@"对手价",@"市价",@"超价"];
    }
    NSInteger count = priceBtnTitles.count;
    int rowCount = 4;
    ...
    float priceBtnWidth = (TKFT_SCREEN_WIDTH - distanse * (count +1))/count;
